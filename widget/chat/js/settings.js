 ...
 *
 * The debug mode is for a longtime test and theming.
 *
 */
let dev = false;
    ...
    if (!dev) {
        dev = setInterval(async () => {
            ...
            let message = {
                "platform": "Twitch",
                "type": "Message",
                "messageId": "f3daddd0-a1be-4f80-96df-9a2b5468d120",
                "userId": "27638012",
                ...
                "badges": [
                    {
                        "name": "Twitch",
                        "imageUrl": "./images/platform/Twitch.png",
                        "version": 1
                    },
                    {
                        "name": "broadcaster",
                ...
                "subscriptionTier": "",
                "emotes": [],
                "timestamp": "2026-04-15T08:30:24.949Z",
                "isHighlighted": false,
                "isReply": false,
                "additional": {
                    "bits": 0,
            ...
            await pushMessage(type, message);
